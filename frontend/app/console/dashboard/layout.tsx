...
const NAV_ITEMS = [
  { href: '/console/dashboard', label: 'Overview', icon: IconOverview },
  { href: '/console/dashboard/tenants', label: 'Organizations', icon: IconOrganizations },
  { href: '/console/dashboard/plans', label: 'Plans', icon: IconPlans },
] as const;
