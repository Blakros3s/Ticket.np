      ...
      {loading ? (
        ...
        <>
          <div className="dashboard-kpi-grid">
            <Link href="/console/dashboard/tenants" className="stat-card stat-card--interactive">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <section className="surface-panel xl:col-span-2">
              <div className="surface-panel-header">
                ...
                <Link href="/console/dashboard/tenants" className="dashboard-link text-sm">
                  View all →
                </Link>
              </div>
              ...
              {recentTenants.length === 0 ? (
                <div className="empty-state py-8">
                  ...
                  <Link href="/console/dashboard/tenants" className="btn-primary mt-4 inline-flex">
                    Create organization
                  </Link>
                </div>
              ) : (
                  ...
                  <table className="server-table">
                    ...
                    <tbody>
                      {recentTenants.map((tenant) => (
                        <tr key={tenant.id}>
                          <td>
                            <Link href={`/console/dashboard/tenants/${tenant.id}`} className="server-table-link">
                              {tenant.name}
                            </Link>
            ...
            <section className="surface-panel">
              ...
              <div className="server-quick-actions">
                <Link href="/console/dashboard/tenants" className="server-quick-action">
                ...
                <Link href="/console/dashboard/plans" className="server-quick-action">
              ...
              <div className="server-info-box mt-5">
                ...
                <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
                  You are signed in as a platform administrator. Tenant users sign in separately at the organization login page.
                </p>
              </div>
            </section>
          </div>
