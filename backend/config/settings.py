...
MIDDLEWARE = [
    ...
    'apps.platform.middleware.PlatformAdminSchemaMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.platform.context_processors.platform_admin_context',
            ],
        },
    },
]
...
SIMPLE_JWT = {
    ...
    # Keep the same refresh token across tab refreshes; blacklist only on explicit logout.
